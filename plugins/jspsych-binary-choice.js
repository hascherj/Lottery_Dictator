...
jsPsych.plugins["binary-choice"] = (function () {
  ...
  plugin.trial = function (display_element, trial) {
    ...
    var display_stage = function () {
      ...
      new_html += '<div class="col">';
      new_html += '<div class="container-multi-choice-column" id= "multiattribute-choices-stimulus-left">';
      new_html += `<div id="multiattribute-choices-stimulus-left " ><img height="100px" width="100px" src="${trial.stimulus[0]}"/></div>`;
      new_html += '</div>';
      new_html += '</div>';
      new_html += '<div class="col">';
      new_html += '<div class="container-multi-choice-column" id= "multiattribute-choices-stimulus-right">';
      new_html += `<div id="multiattribute-choices-stimulus-right " ><img height="100px" width="100px" src="${trial.stimulus[1]}"/></div>`;
      new_html += '</div>';
      new_html += '</div>';
